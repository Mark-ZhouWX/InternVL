...
# # single-round single-image conversation
# question = "translate the English to the Chinese: UN Chief Says There Is No Military Solution in Syria"# Please describe the picture in detail
# # response = model.chat(tokenizer, pixel_values, question, generation_config)
# response = model.language_model.chat(tokenizer, question, meta_instruction="", **generation_config)
# print(question, response)
