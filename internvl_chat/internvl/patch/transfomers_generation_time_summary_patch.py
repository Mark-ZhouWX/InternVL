...
from transformers import LogitsProcessorList, GenerationConfig, StoppingCriteriaList
...
def replace_transformers_generator_sample():
    transformers.generation.GenerationMixin._sample = _sample
    print('Monkey patch transformers.generation.GenerationMixin._sample')
